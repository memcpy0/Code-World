...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042122225.png)
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042122133.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042122583.png)
...
```
 **参数说明**
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042123259.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042123472.png)
...
如下：
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042123222.png)

响应：
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042123925.png)
...
进入网站应用，添加应用
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042124035.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042124244.png)


1、在内网穿透服务器上开通隧道，配置外网域名，配置穿透内网的端口即本地电脑上的端口。
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042124466.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042125835.png)
...
  _log_.debug("微信扫码回调,code:{},state:{}",code,state);  
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042125457.png)
 

点击微信图标打开二维码
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042126525.png)
...
    //请求微信地址  
    String wxUrl = String._format_(wxUrl_template, appid, secret, code);  
  
    _log_.info("调用微信接口申请access_token, url:{}", wxUrl);  
  
    ResponseEntity<String> exchange = restTemplate.exchange(wxUrl, HttpMethod._POST_, null, String.class);  
  
    String result = exchange.getBody();  
    _log_.info("调用微信接口申请access_token: 返回值:{}", result);  
    Map<String,String> resultMap = JSON._parseObject_(result, Map.class);  
...
    //请求微信地址  
    String wxUrl = String._format_(wxUrl_template, access_token,openid);  
...
        return null;  
    }  
    System._out_.println(access_token_map);  
...
        return xcUser;  
    }  
    String userId = UUID.r_andomUUID(_).toString();  
    xcUser = new XcUser();  
    xcUser.setId(userId);  
...
    xcUser.setCreateTime(LocalDateTime.n_ow(_));  
    xcUserMapper.insert(xcUser);  
    XcUserRole xcUserRole = new XcUserRole();  
    xcUserRole.setId(UUID.r_andomUUID(_).toString());  
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042127714.png)
...
![](file:///C:\Users\21839\AppData\Local\Temp\ksohtml9796\wps152.jpg) 
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042128139.png)
...
@ResponseStatus(HttpStatus._INTERNAL_SERVER_ERROR_)  
public RestErrorResponse exception(Exception e) {  
  
   _log_.error("【系统异常】{}",e.getMessage(),e);  
   e.printStackTrace();  
   if(e.getMessage().equals("不允许访问")){  
      return new RestErrorResponse("没有操作此功能的权限");  
   }  
   return new RestErrorResponse(CommonError._UNKOWN_ERROR_.getErrMessage());  
...
登录成功，点击“教学机构”
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042128437.png)


当用户没有权限时页面提示：没有操作此功能的权限。

![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042129573.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042129004.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042129344.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042129896.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042130460.png)
 
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042130588.png)
...
    return courseBaseInfoService.queryCourseBaseList(Long._parseLong_(companyId),pageParams,queryCourseParams);  
}
```
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042130341.png)
 

跟踪持久层日志发现已将机构id传入dao方法，拼装sql语句，查询本机构的课程信息

![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042130437.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042131670.png)
...
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202304042131369.png)
