# 1. 项目概述
## 1.1 项目介绍
传智健康管理系统是一款应用于**健康管理机构**（体检机构）的业务系统，实现健康管理机构**工作内容可视化**、会员管理专业化、**健康评估数字化**、健康干预流程化、**知识库集成化**，从而提高健康管理师的工作效率，加强与会员间的互动，增强管理者对健康管理机构运营情况的了解。
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202303041352368.png)

![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202303041353587.jpg)
...
### 1.3 技术架构
面向服务架构。技术亮点：
1. 采用SSM基础框架+RPC框架Dubbo实现服务注册与远程调用
2. 使用zookeeper作为分布式注册中心
3. 使用ElementUI+VUE进行页面构建
4. 基于Spring Security实现权限控制，保证系统的访问安全
5. 基于Apache POI实现Excel报表导出
6. 基于Echarts实现图像报表展示
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202303041442114.png)


### 1.4 功能架构
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202303041443750.png)

### 1.5 软件开发流程
软件开发一般会经历如下几个阶段，整个过程是顺序展开，所以通常称为瀑布模型。可行性研究与计划->需求分析->设计->编码->测试->运行维护。

---
# 2. 环境搭建
## 2.1 项目结构
本项目采用**Maven分模块开发方式**，即对整个项目拆分为几个Maven工程，每个Maven工程存放特定的一类代码，具体如下：
![](https://image-1307616428.cos.ap-beijing.myqcloud.com/Obsidian/202303041444516.png)
