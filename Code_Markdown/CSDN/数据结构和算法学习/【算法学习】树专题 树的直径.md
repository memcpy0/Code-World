...
```
如果这里不能理解，可以先看二叉树的直径这一题[[LeetCode 543. Diameter of Binary Tree【二叉树,DFS】简单]]。更多题目见[[LeetCode 1617. Count Subtrees With Max Distance Between Cities【数学,二进制枚举,位操作,状压,树型DP,BFS,DFS】困难]]。
