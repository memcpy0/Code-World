...
"""This file contains class definitions for:
  1.Hist: represents a histogram (map from values to integer frequencies).
  2.Pmf: represents a probability mass function (map from values to probs).  代表了一个概率密度函数
  3._DictWrapper: private parent class for Hist and Pmf.
  4.Cdf: represents a discrete cumulative distribution function
  5.Pdf: represents a continuous probability density function
"""
