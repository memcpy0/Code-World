...
[多个线程Alan](https://juejin.cn/user/2984545026065883)
...
 你再仔细看看文章，socketchannel注册到selector上这个操作，会被封装为一个异步任务。单线程执行器启动以后就会去执行这个任务，然后就注册成功了。
